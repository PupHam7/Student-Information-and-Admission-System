...
document.addEventListener('DOMContentLoaded', function () {
  ...
  submitBtn.addEventListener('click', async function () {
    ...
    try {
      ...
      document.getElementById('displayControlNo').textContent = applicant.controlNumber || controlNumber;
      ...
      /* ── Approval badge ── */
      renderApprovalBadge(applicant.isConfirmed);
      ...
      credDisplay.innerHTML = `
        <div style="
          ...
          <div style="
            ...
            <p style="margin:0; font-size:22px; font-weight:800; color:#1e40af; letter-spacing:1px;">
